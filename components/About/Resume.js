      ...
      <FadeIn>
        <div style={{ ...styles.container, width: !smallVw && 850 }}>
          ...
          >
            ...
            <li style={styles.basicText}>
              Internally developed a Month-End-Close task management SaaS
            ...
            <li style={styles.basicText}>
              ...
              Quickbooks Online, a Python notebook to fully reconcile Shopify,
              shipping, and payment data (3 way match), and a dynamic dashboard to
              view real-time Budget v. Actual financials.
            </li>
            <li style={styles.basicText}>
          ...
          <div style={styles.educationContainer}>
            ...
            <p style={styles.educationText("right")}>Cohort: 2018</p>
          </div>
          <div style={styles.educationContainer}>
            <p style={styles.educationText()}>
              William Paterson University - BS, Accounting
            </p>
            <p style={styles.educationText("right")}>Class: 2016</p>
          </div>
        </div>
      </FadeIn>
    </div>
